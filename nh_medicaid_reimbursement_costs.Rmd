...
From 2019 to 2021, service providers were reimbursed an average of $241.80 per claim for behavioral health-related claims by people who matched to Medicaid and were incarcerated in NH jails between 2019 and 2021.  
...
reactable(cost_table,
          ...
          fullWidth = FALSE,
          columns = list(
            total_cost = colDef(format = colFormat(currency = "USD"), name = "Total Reimbursed from 2019 to 2021"),
            min        = colDef(format = colFormat(currency = "USD"), name = "Minimum Reimbursed Per Claim from 2019 to 2021"),
            median     = colDef(format = colFormat(currency = "USD"), name = "Median Reimbursed Per Claim from 2019 to 2021"),
            mean       = colDef(format = colFormat(currency = "USD"), name = "Average Reimbursed Per Claim from 2019 to 2021"),
            max        = colDef(format = colFormat(currency = "USD"), name = "Maximum Reimbursed Per Claim from 2019 to 2021"))
          )
```
...
ggsave(PRES_gg_costs_hu, file="img/PRES_gg_costs_hu.png", width = 9,  height = 5, dpi = 100, bg = 'transparent')
knitr::include_graphics("img/PRES_gg_costs_hu.png")
```
...
reactable(cost_table,
          ...
          columns = list(
            ...
            total_cost = colDef(format = colFormat(currency = "USD"), name = "Total Reimbursed from 2019 to 2021"),
            min        = colDef(format = colFormat(currency = "USD"), name = "Minimum Reimbursed Per Diagnosis/Service from 2019 to 2021"),
            median     = colDef(format = colFormat(currency = "USD"), name = "Median Reimbursed Per Diagnosis/Service from 2019 to 2021"),
            mean       = colDef(format = colFormat(currency = "USD"), name = "Average Reimbursed Per Diagnosis/Service from 2019 to 2021"),
            max        = colDef(format = colFormat(currency = "USD"), name = "Maximum Reimbursed Per Diagnosis/Service from 2019 to 2021"))
          ) 
```
...
PRES_gg_diagnosis_costs_hu <- ggplot(cost_data, aes(fill=finding, y=amt, x = reorder(dx_prmry_clinical_classification_new, amt))) + 
  geom_bar(position="dodge", stat="identity") +
  theme_with_grid_with_labels +
...
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_diagnosis_costs_hu, file="img/PRES_gg_diagnosis_costs_hu.png", width = 20,  height = 5, dpi = 100, bg = 'transparent')
knitr::include_graphics("img/PRES_gg_diagnosis_costs_hu.png")
```

```{r}
# GGplot grouped barchart showing the average and media cost of reimbursement for the diagnosis categories
PRES_gg_diagnosis_costs_hu1 <- 
...
```
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_diagnosis_costs_hu1, file="img/PRES_gg_diagnosis_costs_hu1.png", width = 12,  height = 8, dpi = 100, bg = 'transparent')
knitr::include_graphics("img/PRES_gg_diagnosis_costs_hu1.png")
```
<br>
...
PRES_gg_diagnosis_costs_hu2 <- cost_data %>%
...
```
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_diagnosis_costs_hu2, file="img/PRES_gg_diagnosis_costs_hu2.png", width = 14,  height = 7, dpi = 100, bg = 'transparent')
knitr::include_graphics("img/PRES_gg_diagnosis_costs_hu2.png")
```
