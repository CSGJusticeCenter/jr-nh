...
PRES_gg_costs_hu <- ggplot(cost_data, aes(fill=finding, y=amt, x=hu_group_exclusive)) + 
  ...
  scale_fill_manual(values=c(jri_orange, jri_dark_blue)) +
    theme(axis.title.y = element_text(size = 22, color = jri_gray),
...
color.labels <- cost_data %>% 
  mutate(color = ifelse(dx_prmry_clinical_classification_new == "Opioid-related disorders", yes = jri_green, no = jri_gray))
...
PRES_gg_primary_diagnosis_cost <- cost_data %>%
  ...
  geom_text(aes(label = paste0("$", comma(total_cost)), fontface = 'bold'), 
                color = ifelse(cost_data$dx_prmry_clinical_classification_new=="Opioid-related disorders", jri_green, jri_gray), 
...
ggsave(PRES_gg_primary_diagnosis_cost, file="img/PRES_gg_primary_diagnosis_cost.png", width = 15,  height = 6, dpi = 100)
knitr::include_graphics("img/PRES_gg_primary_diagnosis_cost.png")
```
...
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
# ggsave(PRES_gg_diagnosis_costs, file="img/PRES_gg_diagnosis_costs.png", width = 20,  height = 5, dpi = 100, bg = 'transparent')
# knitr::include_graphics("img/PRES_gg_diagnosis_costs.png")
```
...
```
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
# ggsave(PRES_gg_diagnosis_costs1, file="img/PRES_gg_diagnosis_costs1.png", width = 12,  height = 8, dpi = 100, bg = 'transparent')
# knitr::include_graphics("img/PRES_gg_diagnosis_costs1.png")
```
<br>
...
```
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_diagnosis_costs2, file="img/PRES_gg_diagnosis_costs2.png", width = 14,  height = 7, dpi = 100, bg = 'transparent')
knitr::include_graphics("img/PRES_gg_diagnosis_costs2.png")
```
