...
The table below shows the number of HU bookings, proportion of HU bookings out of all bookings, and the average number of bookings per year for the three types of HU's for each county.
...
The table below shows the number of non-HU bookings, proportion of non-HU bookings out of all bookings, and the average number of bookings per year for the three types of non-HU's for each county.
