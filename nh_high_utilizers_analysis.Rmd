...
PRES_gg_hu_pct_barchart <- ggplot(data1, aes(x = fy, y = total, fill = hu_group_overall)) +
  geom_col(colour = NA, position = "fill") +
  scale_y_continuous(labels = scales::percent) +
...
```{r, out.width="50%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_hu_pct_barchart, file="img/PRES_gg_hu_pct_barchart.png", width = 7,  height = 4, dpi = 100)
