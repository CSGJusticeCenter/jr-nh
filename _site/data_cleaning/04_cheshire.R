...
save(cheshire_adm,            file="converted_data/cheshire_adm.Rda")
save(cheshire_booking,        file="converted_data/cheshire_booking.Rda")
save(cheshire_sentence,       file="converted_data/cheshire_sentence.Rda")
save(cheshire_race,           file="converted_data/cheshire_race.Rda")
save(cheshire_sex,            file="converted_data/cheshire_sex.Rda")
save(cheshire_heatmap,        file="converted_data/cheshire_heatmap.Rda")
save(cheshire_hu_sentence,    file="converted_data/cheshire_hu_sentence.Rda")
