...
sullivan_adm <- sullivan_adm %>% anti_join(all_nas) %>% distinct()
...
save(sullivan_adm, file=paste0(sp_data_path, "/Data/r_data/data_dictionaries_page/sullivan_adm.Rda", sep = ""))
