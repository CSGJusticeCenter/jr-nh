...
load(file=paste0(sp_data_path, "/Data/r_data/belknap_bookings.rds"))
...
load(file=paste0(sp_data_path, "/Data/r_data/carroll_bookings.rds"))
...
load(file=paste0(sp_data_path, "/Data/r_data/cheshire_bookings.rds"))
...
load(file=paste0(sp_data_path, "/Data/r_data/merrimack_bookings.rds"))
