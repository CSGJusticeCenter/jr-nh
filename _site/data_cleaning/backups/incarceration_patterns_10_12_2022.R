...
hu_avg_bookings_3_pct <- fnc_avg_bookings_fy(nh_booking_no_pc_hold, "high_utilizer_3_pct", "Yes")
...
hu_num_bookings_3_pct <- fnc_num_bookings_fy(nh_booking_no_pc_hold, "high_utilizer_3_pct", "Yes")
...
hu_avg_bookings_3_pct_3yr <- fnc_avg_bookings_3yr(nh_booking_no_pc_hold, "high_utilizer_3_pct", "Yes")
...
hu_num_bookings_3_pct_3yr <- fnc_num_bookings_3yr(nh_booking_no_pc_hold, "high_utilizer_3_pct", "Yes")
