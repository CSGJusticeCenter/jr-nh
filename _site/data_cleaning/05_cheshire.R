...
cheshire_hu <- fnc_hu_table(cheshire_adm_19, cheshire_adm_20, cheshire_adm_21)
...
# custom function to create table
cheshire_bookings <- fnc_booking_table(cheshire_booking_19, cheshire_booking_20, cheshire_booking_21)
...
cheshire_high_utilizers_booking  <- fnc_hu_setup(cheshire_booking)
...
cheshire_booking$month_year_text <- format(as.Date(cheshire_booking$booking_date, "%d/%m/%Y"), "%b %Y")
cheshire_booking$month_year      <- as.Date(as.yearmon(cheshire_booking$month_year_text))

# custom function to generate a highchart showing pc hold bookings over time (month and year)
cheshire_pch_time_highchart <- fnc_pch_time_highchart(cheshire_booking)
...
save(cheshire_adm_all,      file=paste0(sp_data_path, "/Data/r_data/cheshire_adm_all.rds", sep = ""))
save(cheshire_adm,          file=paste0(sp_data_path, "/Data/r_data/cheshire_adm.rds", sep = ""))
save(cheshire_bookings,     file=paste0(sp_data_path, "/Data/r_data/cheshire_bookings.rds", sep = ""))
save(cheshire_sentence,     file=paste0(sp_data_path, "/Data/r_data/cheshire_sentence.rds", sep = ""))
save(cheshire_hu,           file=paste0(sp_data_path, "/Data/r_data/cheshire_hu.rds", sep = ""))
save(cheshire_race,         file=paste0(sp_data_path, "/Data/r_data/cheshire_race.rds", sep = ""))
save(cheshire_sex,          file=paste0(sp_data_path, "/Data/r_data/cheshire_sex.rds", sep = ""))
save(cheshire_heatmap,      file=paste0(sp_data_path, "/Data/r_data/cheshire_heatmap.rds", sep = ""))
save(cheshire_hu_booking,   file=paste0(sp_data_path, "/Data/r_data/cheshire_hu_booking.rds", sep = ""))
save(cheshire_hu_sentence,  file=paste0(sp_data_path, "/Data/r_data/cheshire_hu_sentence.rds", sep = ""))
save(cheshire_hu_race,      file=paste0(sp_data_path, "/Data/r_data/cheshire_hu_race.rds", sep = ""))
save(cheshire_hu_sex,       file=paste0(sp_data_path, "/Data/r_data/cheshire_hu_sex.rds", sep = ""))

# save plots to sharepoint
save(cheshire_pch_time_highchart, file=paste0(sp_data_path, "/Data/r_data/cheshire_pch_time_highchart.rds", sep = ""))
