...
### % of Booking with any Drug/Alcohol Charge by Jail (Non-PC Holds Only)
...
### % Bookings with any Drug/Alcohol Charge over Time (Non-PC Holds Only)
...
### % Bookings with any Drug/Alcohol Charge for Individuals who are High Utilizers (based on all three years of data) 
...
## Charge Data Visuals (most serious charge)
...
### % Bookings with any Drug/Alcohol Charge by County (Non-PC Holds Only), Bar Plot
...
### % Bookings with Drug/Alcohol Charges by Jail (Non-PC Holds Only), Map
...
### % Probation/Parole Violation, FTA/Bail, and Public Order Charges by Jail for High Utlizers (based on all three years of data), Map
