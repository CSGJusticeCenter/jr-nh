...
Note: These booking frequencies by charge type are grouped by fiscal year of booking and exclude unclassified charges (i.e., "other")
...
Note: These booking frequencies by charge type are grouped by county of booking and exclude unclassified charges (i.e., "other")
...
Note: This analysis of the % of bookings which are probation/parole violations for the top 10% of HU are presented by county of booking. This map highlights county-level variation but grouping counties into four equally sized groups or quartiles.
