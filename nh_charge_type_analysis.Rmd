...
### Table 3. Charge Type for Individuals who are High Utilizers (based on all three years of data) 
...
### Figure 2. Charge Type over Time (Non-PC Holds Only)
...
### Figure 3. Charge Type by County (Non-PC Holds Only), Bar Plot
...
### Figure 4. Percent of Bookings with any Drug/Alcohol Charge by County (Non-PC Holds Only), Bar Plot
...
### Figure 7. Charge Type by High Utilizer Grouping (Non-PC Holds Only), Bar Plot (based on all three years of data) 
