...
Note: This table is unique by individual, not booking. **Hillsborough and Carroll are excluded because they did not include race/ethnicity data for Hispanic individuals**
...
nh_eight_county_medicaid_match_final_race <- jail_medicaid_analytic_individual_booking_level_dedup_hu_recode %>% 
  ...
  filter(!race%in%c("Missing","Unknown"),
         !county%in%c("Carroll","Hillsborough"))
