...
### Table 3: How long does Medicaid re-enrollment take? (Enrollment-level)
...
### Table 4: Average Jail Length of Stay when Medicaid Enrollment/Eligibility Ends (Enrollment-level)
