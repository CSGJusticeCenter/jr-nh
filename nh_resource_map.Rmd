...
ggplot(
 ...
 geom_label(
     ...
     aes(geometry = geometry, 
         label = county),
    vjust = ifelse((nh_acs_census_county_geo_to_map$geometry==nh_acs_census_county_geo_to_map$geometry[nh_acs_census_county_geo_to_map$county %in% c("Hillsborough")] | 
                      nh_acs_census_county_geo_to_map$geometry==nh_acs_census_county_geo_to_map$geometry[nh_acs_census_county_geo_to_map$county %in% c("Merrimack")] | 
                      nh_acs_census_county_geo_to_map$geometry==nh_acs_census_county_geo_to_map$geometry[nh_acs_census_county_geo_to_map$county %in% c("Carroll")]), 1.15, 0),
...
ggplot(
 ...
 #  )) +
  ...
  #    aes(geometry = geometry, 
  #        label = county),
  #    # vjust = ifelse(df_county_level_charge_type_summary_geo_to_map$geometry==df_county_level_charge_type_summary_geo_to_map$geometry[df_county_level_charge_type_summary_geo_to_map$county %in% c("Merrimack","Hillsborough","Carroll")], 1, 0),
  #   # hjust = ifelse(iowa_offense_change_census_district_geo$geometry==iowa_offense_change_census_district_geo$geometry[iowa_offense_change_census_district_geo$judicial_district %in% c("District 7")], 1, .5),
  #   family = "Franklin Gothic Demi",
  #   color = "gray25",
  #   size = 3,
  #   fontface = "bold",
