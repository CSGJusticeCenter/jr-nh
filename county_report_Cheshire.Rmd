...
load(paste0(sp_data_path, "/Data/r_data/county_hu_3_pct_prop.Rda",      sep = ""))
load(paste0(sp_data_path, "/Data/r_data/county_hu_5_pct_prop.Rda",      sep = ""))
load(paste0(sp_data_path, "/Data/r_data/county_pc_hold_recordings.Rda", sep = ""))
...
```{r}
df <- county_hu_1_pct_prop %>% filter(county == county_name) %>% ungroup() %>% select(-county) %>% droplevels() 
reactable(df,
         pagination = FALSE,
         sortable = FALSE,
