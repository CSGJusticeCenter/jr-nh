...
#####
# medicaid encounters with cost and diagnoses information 
...
```{r}
# Count number and proportion of people with MH claims
# By HU group
...
medicaid_match_mh_all <- medicaid_match_mh_all %>% 
  mutate(population = factor(population, 
                             levels = c("Individuals w/out MH Service Encounter, Primary Diagnosis",
                                        "Individuals w/ MH Service Encounter, Primary Diagnosis"),
                             labels = c("Individuals w/out MH Service Claim",
                                        "Individuals w/ MH Service Claim"))) %>% 
  mutate(pct1 = round(pct*100, 0))

ggplot(medicaid_match_mh_all, aes(x = reorder(hu_group_overall, desc(hu_group_overall)), y = pct, fill = population)) +
  ...
  geom_text(aes(label = paste(round(pct*100, 0), "%", sep = ""), 
            ...
            color = case_when(medicaid_match_mh_all$population == "Individuals w/ MH Service Claim" ~ "white",
                              TRUE ~ "black")) +
  theme_minimal() +
  coord_flip() +
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_medicaid_mh.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 10,
...
```{r}
# Count number and proportion of people with SUD claims
# By HU group
...
medicaid_match_sud_all <- medicaid_match_sud_all %>% 
  mutate(population = factor(population, 
                             levels = c("Individuals w/out SUD Service Encounter, Primary Diagnosis",
                                        "Individuals w/ SUD Service Encounter, Primary Diagnosis"),
                             labels = c("Individuals w/out SUD Service Claim",
                                        "Individuals w/ SUD Service Claim"))) %>% 
  mutate(pct1 = round(pct*100, 0))

ggplot(medicaid_match_sud_all, aes(x = reorder(hu_group_overall, desc(hu_group_overall)), y = pct, fill = population)) +
  geom_col(colour = "white", position = "fill") +
  scale_y_continuous(labels = scales::percent,
                     limits = c(0,1.3)) +
  ...
  geom_text(aes(label = paste(round(pct*100, 0), "%", sep = ""), 
            ...
            vjust = 0.8,
            size = 10, family = "Franklin Gothic Book",
            color = case_when(medicaid_match_sud_all$population == "Individuals w/ SUD Service Claim" ~ "white",
                              TRUE ~ "black")) +
  theme_minimal() +
  coord_flip() +
  guides(fill = guide_legend(reverse = TRUE)) +
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_medicaid_sud.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 10,
...
```{r}
# Count number and proportion of people with BH claims
# by HU
...
ggplot(medicaid_match_bh, aes(x = reorder(hu_group_exclusive, desc(hu_group_exclusive)), y = pct, fill = population)) +
  geom_col(colour = "white", position = "fill") +
  scale_y_continuous(labels = scales::percent,
                     limits = c(0,1.3)) +
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_medicaid_match_bh.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 10,
...
```{r}
# Count number and proportion of people with cooccurring claims
# by hu_group_exclusive
...
# Stacked bar chart showing the proportion of people matched to Medicaid by hu_group_exclusive
ggplot(medicaid_match_cooccurring, aes(x = reorder(hu_group_exclusive, desc(hu_group_exclusive)), y = pct, fill = population)) +
  geom_col(colour = "white", position = "fill") +
  scale_y_continuous(labels = scales::percent,
                     limits = c(0, 1.3)) +
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_medicaid_match_cooccurring.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 10,
...
```{r echo=FALSE,message=FALSE,warning=FALSE} 
# Count number and proportion of people with SMI and opioid claims
# by hu_group_overall
...
```{r}
# Count number and proportion of people with SMI claims
# by hu_group_exclusive
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_medicaid_jail_smi_hu_grouping1.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 10,
...
ggplot(medicaid_jail_smi_county, aes(x = county, y = pct, fill = population)) +
  geom_col(colour = "white", position = "fill") +
  scale_y_continuous(labels = scales::percent) +
  scale_fill_manual(values=c("gray",jri_orange),
                    na.value = "white") +
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_medicaid_jail_smi_county.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 9,
...
```{r}
# Count number and proportion of people with opioid claims
# by hu_group_exclusive
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_medicaid_jail_opioid1.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 10,
...
ggplot(medicaid_jail_opioid_county, aes(x = county, y = pct, fill = population)) +
  geom_col(colour = "white", position = "fill") +
  scale_y_continuous(labels = scales::percent) +
  scale_fill_manual(values=c("gray",jri_green),
                    na.value = "white") +
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_medicaid_jail_opioid_county.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 9,
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_medicaid_top_diagnoses.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 12,
...
```{r}
# Find top SMI primary diagnoses and the proportion of claims for each
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_medicaid_smi_primary_diagnoses.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 12,
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_smi_primary_diagnoses_hu.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 14,
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_smi_primary_diagnoses_tier1hu.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 14,
...
# Previously was using medicaid_encounters_cleaned_2018_2021 but using suicide-related flag in jail_medicaid_analytic_individual_booking_level_dedup_hu_recode is more reliable
...
# Count number and proportion of people with SMI claims
# by hu_group_exclusive
smi_suicide_related_hu <- jail_medicaid_analytic_individual_booking_level_dedup_hu_recode %>% 
  dplyr::group_by(hu_group_exclusive) %>% 
  dplyr::summarise(`Individuals w/ any Medicaid Match (N)`                                 = n_distinct(unique_person_id[pre_or_study_window_medicaid_match_flag_overall==1]),
                   `Individuals w/ suicidal ideation/attempt/intentional self-harm (N)`    = n_distinct(unique_person_id[pre_or_study_suicide_related_flag==1]),
                   `Individuals w/ suicidal ideation/attempt/intentional self-harm (%)`    = `Individuals w/ suicidal ideation/attempt/intentional self-harm (N)`/`Individuals w/ any Medicaid Match (N)`,
                   `Individuals w/out suicidal ideation/attempt/intentional self-harm (%)` = 1-`Individuals w/ suicidal ideation/attempt/intentional self-harm (%)`) %>% 
  ungroup() %>% 
  select(-c(`Individuals w/ any Medicaid Match (N)`,
            `Individuals w/ suicidal ideation/attempt/intentional self-harm (N)`))

# Count number and proportion of people with suicide-related claims
# by state
smi_suicide_related_hu_state <- jail_medicaid_analytic_individual_booking_level_dedup_hu_recode %>% 
  dplyr::summarise(`Individuals w/ any Medicaid Match (N)`                                 = n_distinct(unique_person_id[pre_or_study_window_medicaid_match_flag_overall==1]),
                   `Individuals w/ suicidal ideation/attempt/intentional self-harm (N)`    = n_distinct(unique_person_id[pre_or_study_suicide_related_flag==1]),
                   `Individuals w/ suicidal ideation/attempt/intentional self-harm (%)`    = `Individuals w/ suicidal ideation/attempt/intentional self-harm (N)`/`Individuals w/ any Medicaid Match (N)`,
                   `Individuals w/out suicidal ideation/attempt/intentional self-harm (%)` = 1-`Individuals w/ suicidal ideation/attempt/intentional self-harm (%)`) %>% 
...
# change from wide to long format
smi_suicide_related_hu <- gather(smi_suicide_related_hu, population, pct, `Individuals w/ suicidal ideation/attempt/intentional self-harm (%)`:`Individuals w/out suicidal ideation/attempt/intentional self-harm (%)`, 
                                 factor_key=TRUE) 
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_smi_suicide_related_hu.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 11,
...
# Count number and proportion of people with suicide-related diagnoses
# by hu_group_overall
smi_suicide_related_hu <- jail_medicaid_analytic_individual_booking_level_dedup_hu_recode %>% 
  dplyr::group_by(hu_group_overall) %>% 
  dplyr::summarise(`Individuals w/ any Medicaid Match (N)`                                 = n_distinct(unique_person_id[pre_or_study_window_medicaid_match_flag_overall==1]),
...
ggplot(smi_suicide_related_hu,
         aes(x = reorder(hu_group_overall, desc(hu_group_overall)), y = pct, fill = population)) +
  geom_bar(stat = "identity") +
  scale_y_continuous(labels = scales::percent,
                     limits = c(0,1.3)) +
  scale_fill_manual(values=c("gray",jri_light_blue),
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_smi_suicide_related_hu_overall.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 11,
...
# Previously was using medicaid_encounters_cleaned_2018_2021 but using alcohol-related flag in jail_medicaid_analytic_individual_booking_level_dedup_hu_recode is more reliable
...
# Count number and proportion of people with alcohol-related disorders
# by hu_group_exclusive
alcohol_related_hu <- jail_medicaid_analytic_individual_booking_level_dedup_hu_recode %>% 
  dplyr::group_by(hu_group_exclusive) %>% 
  dplyr::summarise(`Individuals w/ any Medicaid Match (N)`           = n_distinct(unique_person_id[pre_or_study_window_medicaid_match_flag_overall==1]),
                   `Individuals w/ alcohol-related disorders (N)`    = n_distinct(unique_person_id[pre_or_study_alcohol_related_flag==1]),
                   `Individuals w/ alcohol-related disorders (%)`    = `Individuals w/ alcohol-related disorders (N)`/`Individuals w/ any Medicaid Match (N)`,
                   `Individuals w/out alcohol-related disorders (%)` = 1-`Individuals w/ alcohol-related disorders (%)`) %>% 
  ungroup() %>% 
  select(-c(`Individuals w/ any Medicaid Match (N)`,
            `Individuals w/ alcohol-related disorders (N)`))

# Count number and proportion of people with alcohol-related disorders
# by state
alcohol_related_hu_state <- jail_medicaid_analytic_individual_booking_level_dedup_hu_recode %>% 
  dplyr::summarise(`Individuals w/ any Medicaid Match (N)`           = n_distinct(unique_person_id[pre_or_study_window_medicaid_match_flag_overall==1]),
                   `Individuals w/ alcohol-related disorders (N)`    = n_distinct(unique_person_id[pre_or_study_alcohol_related_flag==1]),
                   `Individuals w/ alcohol-related disorders (%)`    = `Individuals w/ alcohol-related disorders (N)`/`Individuals w/ any Medicaid Match (N)`,
                   `Individuals w/out alcohol-related disorders (%)` = 1-`Individuals w/ alcohol-related disorders (%)`) %>% 
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_alcohol_related_hu.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 11,
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_alcohol_related_hu_overall.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 100,
    width = 10,
