...
PRES_gg_medicaid_mh <- ggplot(medicaid_match_mh_all, aes(x = reorder(hu_group_overall, desc(hu_group_overall)), y = pct, fill = population)) +
  ...
  theme(panel.grid.minor.y = element_blank(),
        ...
        axis.text.y = element_text(size = 28, color = jri_gray),
        ...
        legend.text = element_text(family = "Franklin Gothic Book", size = 28, color = jri_gray))
```

```{r, out.width="50%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_medicaid_mh, file="img/PRES_gg_medicaid_mh.png", width = 10,  height = 6, dpi = 100)
...
```{r, out.width="50%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_medicaid_sud, file="img/PRES_gg_medicaid_sud.png", width = 10,  height = 6, dpi = 100)
...
PRES_gg_medicaid_match_bh <- ggplot(medicaid_match_bh, aes(x = reorder(hu_group_exclusive, desc(hu_group_exclusive)), y = pct, fill = population)) +
  ...
  theme(panel.grid.minor.y = element_blank(),
        ...
        axis.title.y = element_blank(),
        axis.title.x = element_blank(),
        axis.text.x = element_text(color = jri_gray),
        axis.text.y = element_text(color = jri_gray),
        legend.justification = c(0.5, 0.5),
        legend.direction = "vertical",
        legend.box = "horizontal",
        legend.position = "bottom",
        legend.title=element_blank(),
        legend.text = element_text(family = "Franklin Gothic Book", color = jri_gray)) 
  #geom_hline(yintercept = mean(medicaid_match$pct), color=jri_gray, linetype='dotted', lwd=1.5)
```

```{r, out.width="75%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_medicaid_match_bh, file="img/PRES_gg_medicaid_match_bh.png", width = 10,  height = 6, dpi = 100)
...
```{r, out.width="75%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_medicaid_match_cooccurring, file="img/PRES_gg_medicaid_match_cooccurring.png", width = 10,  height = 6, dpi = 100)
...
PRES_gg_medicaid_jail_smi_county <- ggplot(medicaid_jail_smi_county, aes(x = county, y = pct, fill = population)) +
  ...
  theme(panel.grid.minor.y = element_blank(),
        ...
        axis.title.y = element_blank(),
        axis.title.x = element_blank(),
        axis.text.x = element_text(angle = 45, hjust = 0.85, size = 28, color = jri_gray),
        axis.text.y = element_text(size = 28, color = jri_gray),
        legend.title=element_blank(),
        legend.justification = c(0.5, 0.5),
        legend.direction = "vertical",
...
```{r, out.width="75%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_medicaid_jail_smi_county, file="img/PRES_gg_medicaid_jail_smi_county.png", width = 9,  height = 7, dpi = 100)
knitr::include_graphics("img/PRES_gg_medicaid_jail_smi_county.png")
```
...
```{r, out.width="75%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_medicaid_jail_opioid_county, file="img/PRES_gg_medicaid_jail_opioid_county.png", width = 9,  height = 7, dpi = 100)
knitr::include_graphics("img/PRES_gg_medicaid_jail_opioid_county.png")
```
...
PRES_gg_medicaid_top_diagnoses <- top_primary_diagnoses_grouped %>%
  ...
  scale_fill_manual(name = "area", values=c(jri_green,"gray")) +
      geom_text(aes(label = comma(total_claims), fontface = 'bold'
                ...
                color = ifelse(top_primary_diagnoses_grouped$dx_prmry_clinical_classification_new=="Opioid-related disorders", jri_green, jri_gray), 
  ...
  theme(legend.position = "none",
        ...
        axis.text.y = element_text(face = c("plain", "plain", "plain", "plain", "plain", "plain", "plain",  "plain", "bold"), 
                                   color = c( jri_gray,jri_gray,jri_gray,jri_gray,jri_gray,jri_gray,jri_gray,jri_gray,"#557e39" )),
...
color.labels <- smi_primary_diagnoses %>% 
  mutate(color = ifelse(dx_prmry_clinical_classification == "Schizophrenia spectrum and other psychotic disorders", yes = jri_orange, no = jri_gray))
...
PRES_gg_medicaid_smi_primary_diagnoses <- smi_primary_diagnoses %>%
  ...
  scale_fill_manual(name = "area", values=c(jri_orange,"gray")) +
      geom_text(aes(label = comma(total_claims), fontface = 'bold'
                ...
                color = ifelse(smi_primary_diagnoses$dx_prmry_clinical_classification=="Schizophrenia spectrum and other psychotic disorders", jri_orange, jri_gray), 
                hjust = -.1, size = 7.5, family = "Franklin Gothic Book") +
  xlab("") + ylab("\nNumber of Claims") +
  scale_y_continuous(labels = label_number(suffix = "k", scale = 1e-3, big.mark = ","),
                     expand = c(0,0),
...
PRES_gg_smi_primary_diagnoses_hu <- smi_primary_diagnoses_hu %>%
 ...
 geom_text(aes(label = paste0(abs(pct), "%")),
            ...
            color = ifelse(smi_primary_diagnoses_hu$hu_group_overall == "High Utilizer", jri_orange, jri_gray),
            fontface = "bold"
              ) +
  ...
  theme(axis.text.x = element_blank(),
        ...
        axis.title.y = element_text(angle = 90, size = 22, color = jri_gray),
        axis.title.x = element_text(size = 22, color = jri_gray),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        legend.position = "top",
...
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_smi_primary_diagnoses_hu, file="img/PRES_gg_smi_primary_diagnoses_hu.png", width = 14,  height = 7, dpi = 100, bg = 'transparent')
knitr::include_graphics("img/PRES_gg_smi_primary_diagnoses_hu.png")
```
...
PRES_gg_smi_primary_diagnoses_tier1hu <- smi_primary_diagnoses_hu %>%
 ...
 geom_text(aes(label = paste0(abs(pct), "%")),
            ...
            color = ifelse(smi_primary_diagnoses_hu$hu_group_exclusive == "Tier 1 HU", jri_light_blue, jri_gray),
            fontface = "bold"
              ) +
  scale_y_continuous(limits = c(-100, 100)) +
...
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_smi_primary_diagnoses_tier1hu, file="img/PRES_gg_smi_primary_diagnoses_tier1hu.png", width = 14,  height = 7, dpi = 100, bg = 'transparent')
knitr::include_graphics("img/PRES_gg_smi_primary_diagnoses_tier1hu.png")
```
<br><br>
...
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_smi_suicide_related_hu, file="img/PRES_gg_smi_suicide_related_hu.png", width = 10,  height = 6, dpi = 100)
knitr::include_graphics("img/PRES_gg_smi_suicide_related_hu.png")
```
...
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_alcohol_related_hu, file="img/PRES_gg_alcohol_related_hu.png", width = 10,  height = 6, dpi = 100)
knitr::include_graphics("img/PRES_gg_alcohol_related_hu.png")
```
