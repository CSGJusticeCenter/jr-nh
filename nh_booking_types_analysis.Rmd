...
PRES_gg_pie_pretrial <- ggplot(data1, aes(x = state, y = total, fill = sentence_status_standard)) +
  ...
  geom_text(aes(label = pct, 
                ...
                color = ifelse(data1$sentence_status_standard == "Other", jri_gray, "white")
            ) +
...
PRES_gg_pretrial_prop <- ggplot(data1, aes(x = county, y = total, fill = sentence_status_standard)) +
  ...
  geom_text(aes(label = ifelse(pct > 4, paste(pct, "%", sep = ""), ""), 
            ...
            color = case_when(data1$sentence_status_standard == "Not Pretrial" ~ jri_gray,
                              TRUE ~ "white")) +
  theme_no_grid_no_labels +
  theme(axis.title.y = element_blank(),
        axis.title.x = element_blank(),
        axis.text.x = element_text(angle = 45, hjust = 0.85, color = jri_gray))
```
...
PRES_gg_pie_drug_court_bookings <- ggplot(data1, aes(x = drug_court, y = total, fill = hu_group_exclusive )) +
  ...
  theme(axis.ticks = element_blank(),
        axis.text.x=element_blank(),
        axis.text.y=element_blank(),
        legend.text = element_text(family = "Franklin Gothic Book", size = 18, color = jri_gray))
```

```{r, out.width="50%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_pie_drug_court_bookings, file="img/PRES_gg_pie_drug_court_bookings.png", width = 6,  height = 6, dpi = 100, bg='transparent')
...
PRES_gg_drugcourt_tier1hu <- ggplot(tier1hu, aes(x = "", y = pct, fill = type)) +
  geom_col(colour = NA, position = "fill") +
  scale_y_continuous(labels = scales::percent) +
...
PRES_gg_drugcourt_tier2hu <- ggplot(tier2hu, aes(x = "", y = pct, fill = type)) +
  geom_col(colour = NA, position = "fill") +
  scale_y_continuous(labels = scales::percent) +
  scale_fill_manual(values=c("#404040", "gray"),
                    labels = c("Drug-court related booking",
...
PRES_gg_drugcourt_tier3hu <- ggplot(tier3hu, aes(x = "", y = pct, fill = type)) +
  geom_col(colour = NA, position = "fill") +
  scale_y_continuous(labels = scales::percent) +
  scale_fill_manual(values=c("#404040", "gray"),
                    labels = c("Drug-court related booking",
  ...
  geom_text(aes(label = paste0(round(pct*100, 0), "%"),
                ...
                size = 7.5,
                family = "Franklin Gothic Book",
                color = ifelse(tier3hu$type == "drug_court_related_booking", jri_gray, "gray")
            ) +
  coord_polar("y", start=0) +
  theme_no_grid_no_labels +
  theme(axis.ticks = element_blank(),
...
PRES_gg_drugcourt_nonhu <- ggplot(nonhu, aes(x = "", y = pct, fill = type)) +
  geom_col(colour = NA, position = "fill") +
  scale_y_continuous(labels = scales::percent) +
  scale_fill_manual(values=c("#404040", "gray"),
                    labels = c("Drug-court related booking",
  ...
  geom_text(aes(label = paste0(round(pct*100, 0), "%"),
                ...
                size = 7.5,
                family = "Franklin Gothic Book",
                color = ifelse(nonhu$type == "drug_court_related_booking", jri_gray, "gray")
            ) +
  coord_polar("y", start=0) +
  theme_no_grid_no_labels +
  theme(axis.ticks = element_blank(),
