...
df1 <- table(df_hus_entrances$sentence_status_standard, df_hus_entrances$hu_group_exclusive)
table1 <- prop.table(df1, 2)
table1 <- as.data.frame(cbind(df1, table1))
...
```{r}
df1 <- table(df_drug_courts$hu_group_exclusive, df_drug_courts$drug_court)
table1 <- prop.table(df1, 2)
table1 <- as.data.frame(cbind(df1, table1))
