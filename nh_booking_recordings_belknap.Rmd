...
Belknap only provided data on charge descriptions, codes, and booking types. There is no information on release types or sentence statuses.  

```{r}
# Belknap only has charge descriptions, codes (sometimes),and booking types
data1 <- adm_all %>%
