...
gg_los_category <- ggplot(data1, aes(los_category, total)) +
  ...
  xlab("Length of Stay (Days)") + ylab("Number of People") +
...
```{r}
# Filter to LOS for all HU's and calculate number of people/prop of people with los category
...
```{r}
# Filter to LOS for all non-HU's and calculate number of people/prop of people with los category
