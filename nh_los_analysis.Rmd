...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_los_category.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 300,
    width = 10,
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_diverge_hu_overall_los_prop1.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 300,
    width = 8,
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_diverge_hu_overall_los_prop2.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 300,
    width = 8,
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_jail_los_category.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 300,
    width = 10,
...
```{r}
ggplot(jail_booking_los_0_1_day, aes(x = state, y = total, fill = sentence_status_standard)) +
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_pie_0_1_los_bookings.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 300,
    width = 8,
...
ggplot(los_0_1_day_crime_tier1hu_nonhu, aes(fill=group, y=pct, x=crime_type_lookup)) + 
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_los_0_1_crime_type.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 300,
    width = 13,
...
ggsave(
    filename = paste0(sp_data_path, "/analysis/img/PRES_gg_crime_los.png"),
    plot = last_plot(),
    device = ragg::agg_png,
    dpi = 300,
    width = 10,
