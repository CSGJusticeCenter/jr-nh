...
medicaid_jail_county_bh_service_type_table <- jail_medicaid_analytic_individual_booking_level_dedup %>% 
  ...
  dplyr::summarise(`Overall Individuals (N)` = n_distinct(unique_person_id),
                   ...
                   `Individuals w/ MH and SUD Service Encounters, Co-Occurring Disorders (N)` = n_distinct(unique_person_id[study_mh_service_primary_dx_flag==1 & study_sud_service_primary_dx_flag==1]),
