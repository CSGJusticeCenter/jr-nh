...
merrimack_hu <- fnc_hu_table(merrimack_adm_19, merrimack_adm_20, merrimack_adm_21)
...
# custom function to create table
merrimack_bookings <- fnc_booking_table(merrimack_booking_19, merrimack_booking_20, merrimack_booking_21)
...
merrimack_high_utilizers_booking  <- fnc_hu_setup(merrimack_booking)
...
merrimack_booking$month_year_text <- format(as.Date(merrimack_booking$booking_date, "%d/%m/%Y"), "%b %Y")
merrimack_booking$month_year      <- as.Date(as.yearmon(merrimack_booking$month_year_text))

# custom function to generate a highchart showing pc hold bookings over time (month and year)
merrimack_pch_time_highchart <- fnc_pch_time_highchart(merrimack_booking)
...
save(merrimack_adm_all,      file=paste0(sp_data_path, "/Data/r_data/merrimack_adm_all.rds", sep = ""))
save(merrimack_adm,          file=paste0(sp_data_path, "/Data/r_data/merrimack_adm.rds", sep = ""))
save(merrimack_bookings,     file=paste0(sp_data_path, "/Data/r_data/merrimack_bookings.rds", sep = ""))
save(merrimack_sentence,     file=paste0(sp_data_path, "/Data/r_data/merrimack_sentence.rds", sep = ""))
save(merrimack_hu,           file=paste0(sp_data_path, "/Data/r_data/merrimack_hu.rds", sep = ""))
save(merrimack_race,         file=paste0(sp_data_path, "/Data/r_data/merrimack_race.rds", sep = ""))
save(merrimack_sex,          file=paste0(sp_data_path, "/Data/r_data/merrimack_sex.rds", sep = ""))
save(merrimack_heatmap,      file=paste0(sp_data_path, "/Data/r_data/merrimack_heatmap.rds", sep = ""))
save(merrimack_hu_booking,   file=paste0(sp_data_path, "/Data/r_data/merrimack_hu_booking.rds", sep = ""))
save(merrimack_hu_sentence,  file=paste0(sp_data_path, "/Data/r_data/merrimack_hu_sentence.rds", sep = ""))
save(merrimack_hu_race,      file=paste0(sp_data_path, "/Data/r_data/merrimack_hu_race.rds", sep = ""))
save(merrimack_hu_sex,       file=paste0(sp_data_path, "/Data/r_data/merrimack_hu_sex.rds", sep = ""))

# save plots to sharepoint
save(merrimack_pch_time_highchart, file=paste0(sp_data_path, "/Data/r_data/merrimack_pch_time_highchart.rds", sep = ""))
