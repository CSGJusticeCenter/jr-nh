...
# County Pages
load(paste0(sp_data_path, "/Data/r_data/county_hu_1_pct_prop.Rda",  sep = ""))
load(paste0(sp_data_path, "/Data/r_data/county_hu_5_pct_prop.Rda",  sep = ""))
load(paste0(sp_data_path, "/Data/r_data/county_hu_10_pct_prop.Rda", sep = ""))
load(paste0(sp_data_path, "/Data/r_data/county_race.Rda",           sep = ""))
load(paste0(sp_data_path, "/Data/r_data/county_age_category.Rda",   sep = ""))
load(paste0(sp_data_path, "/Data/r_data/county_gender.Rda",         sep = ""))

# Incarceration Patterns Page
load(paste0(sp_data_path, "/Data/r_data/amt_people_booked.Rda",     sep = ""))
load(paste0(sp_data_path, "/Data/r_data/row_people_booked.Rda",     sep = ""))
...
load(paste0(sp_data_path, "/Data/r_data/amt_entrances.Rda",                  sep = ""))
load(paste0(sp_data_path, "/Data/r_data/row_entrances_fy.Rda",               sep = ""))
load(paste0(sp_data_path, "/Data/r_data/PRES_gg_entrances.Rda",              sep = ""))
load(paste0(sp_data_path, "/Data/r_data/PRES_table_entrances_fy_county.Rda", sep = ""))
load(paste0(sp_data_path, "/Data/r_data/PRES_table_entrances_people_county.Rda", sep = ""))
load(paste0(sp_data_path, "/Data/r_data/PRES_gg_num_entrances.Rda", sep = ""))

load(paste0(sp_data_path, "/Data/r_data/amt_pch_pct.Rda",                        sep = ""))
load(paste0(sp_data_path, "/Data/r_data/PRES_gg_pch_pct_barchart.Rda",           sep = ""))
