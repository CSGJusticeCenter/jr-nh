...
#1 Belknap
load(file="Data/r_data/belknap_adm_all.rds")
...
#2 Carroll
load(file="Data/r_data/carroll_adm_all.rds")
...
#3 Cheshire
load(file="Data/r_data/cheshire_adm_all.rds")
...
#7 Merrimack
load(file="Data/r_data/merrimack_adm_all.rds")
