...
\usepackage{graphicx}
\usepackage{multirow}%for special tables
...
\definecolor{llyellow}{rgb}{0,1,1}
\definecolor{lyellow}{rgb}{0,0.9,0.9}
\definecolor{yellow}{rgb}{0,0.8,0.8}
\definecolor{sgreen}{rgb}{0.53,0.86,0.41}
...
\newcommand\Fontchangeextra{\fontsize{5}{7.2}\selectfont}
\newcommand\Fontchangeextranew{\fontsize{4.5}{7.2}\selectfont}
\newcommand\Fontchange{\fontsize{8}{7.2}\selectfont}
...
\tikzstyle{blockc} = [rectangle, draw, fill=csgblue, node distance=3.5cm, text centered,
text width=8em, rounded corners, minimum height=2em]

%box block
\tikzstyle{box} = [rectangle, draw, fill=sgreen, text centered,
text width=6em, minimum height=2.5em]
\tikzstyle{boxr} = [rectangle, draw, fill=red, node distance=3.5cm, text centered,
...
%circle block
\tikzstyle{cloudcp} = [circular drop shadow, circle, draw, fill=csgblue!20,
node distance=7.5cm, minimum height=3em]
\tikzstyle{cloudbp} = [circular drop shadow, circle, draw, fill=csggray!20,
