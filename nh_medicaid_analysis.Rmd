...
### why are Mari and my carroll numbers different?
### why are our cheshire comparisons different?
### is one of our carroll files the wrong county? dhhs?

### create df specific to carroll and cheshire for additional exploration 
# carroll_adm <- adm_all %>% 
#   filter(county=="Carroll")
# 
# cheshire_adm <- adm_all %>% 
