...
This table explores the average number of days from the end of Medicaid eligibility (when it occurs during or within 20 days after incarceration) to re-enrollment/the following Medicaid eligibility start date for an individual. Analysis is at the enrollment-level, however


```{r echo=FALSE,message=FALSE,warning=FALSE} 
### HEREHEREHERE
### columns to use: medicaid_eligibility_end_next_begin_diff_days:medicaid_eligibility_end_no_new_begin_flag
