...
Note: This plot explores the handful of outliers that appear in the Medicaid data (e.g., 100+ ED visits). For ease of interpretation, I've removed all individuals with 0 ED Visits (the vast majority at 6,000+) as well as extreme outliers (150+ visits; there are about 20 individuals with more than 150 visits recorded, though some counts seem erroneously high) 
...
plot_ed_visits_statewide_distribution <- jail_medicaid_analytic_individual_booking_level_dedup_ed_visit_count_recode %>%
  filter(pre_or_study_window_medicaid_match_flag_overall==1,
         ...
         pre_or_study_ed_visit_or_service_encounter_count<155) %>% 
