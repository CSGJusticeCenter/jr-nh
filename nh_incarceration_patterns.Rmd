...
ggsave(PRES_gg_dhhs_entrances, file= paste0(sp_data_path, "/analysis/img/PRES_gg_dhhs_entrances.png"), width = 6, height = 5, dpi = 100)
knitr::include_graphics(paste0(sp_data_path, "/analysis/img/PRES_gg_dhhs_entrances.png"))
```
...
# Save and output graph
ggsave(PRES_gg_num_entrances, file= paste0(sp_data_path, "/analysis/img/PRES_gg_num_entrances.png"), width = 19, height = 9, dpi = 100)
knitr::include_graphics(paste0(sp_data_path, "/analysis/img/PRES_gg_num_entrances.png"))
```
