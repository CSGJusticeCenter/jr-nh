...
Each county records PC holds differently. PC holds are recorded in the charge description, booking type, sentence status, or release type, and sometimes across these metrics. See each the **County Reports** in the menu to see how each county records PC holds and the "outcomes" of these holds.  
