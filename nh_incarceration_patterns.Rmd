...
load(paste0(sp_data_path, "/Data/r_data/nh_people_booked_barchart_gg.Rda",  sep = ""))
...
load(paste0(sp_data_path, "/Data/r_data/nh_bookings_barchart_gg.Rda",       sep = ""))
load(paste0(sp_data_path, "/Data/r_data/nh_booking_by_fy.Rda",              sep = ""))

load(paste0(sp_data_path, "/Data/r_data/nh_booking_types.Rda",              sep = ""))

load(paste0(sp_data_path, "/Data/r_data/avg_los_no_pchs.Rda",               sep = ""))
load(paste0(sp_data_path, "/Data/r_data/los_summary.Rda",                   sep = ""))
...
load(paste0(sp_data_path, "/Data/r_data/nh_pch_pct_barchart_gg.Rda",        sep = ""))
...
Counties saw variations in the number of people booked into jails but nearly all saw a decrease in the past three years.
...
```{r, results='asis'}
# print header for pc hold section
cat("**People had an average of ", round(avg_los_no_pchs, 1), " bed days between FY2019 and FY2021.**\n\n", sep = "")
```
```{r}
los_summary
```
