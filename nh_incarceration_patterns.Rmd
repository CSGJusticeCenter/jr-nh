...
cat("**There were ", nh_people_booked_amt, " people booked into NH jails from FY2019 to FY2021.**"," This finding was calculated using data from the following counties: ", nh_counties, ".\n\n", sep = "")
```
```{r}
