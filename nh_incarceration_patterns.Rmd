...
PRES_gg_num_entrances <-
  ...
  geom_text(aes(label = comma(total)), color = "black", vjust = -1, size = 10, family = "Franklin Gothic Book") +
...
# Save and output graph
ggsave(PRES_gg_num_entrances, file= "img/PRES_gg_num_entrances.png", width = 19, height = 9, dpi = 100)
...
```{r}
# Reactable table shoing the cost per person per year and per day
