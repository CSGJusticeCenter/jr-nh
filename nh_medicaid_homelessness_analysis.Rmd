...
jail_medicaid_analytic_individual_booking_level_dedup_hu_recode <- jail_medicaid_analytic_individual_booking_level_dedup %>% 
  ...
  mutate(hu_group_exclusive = case_when(
    ...
    # dplyr::mutate(pre_or_study_window_medicaid_match_flag_overall = ifelse(study_window_medicaid_match_flag_overall == 1 |
    #                                                                        pre_study_window_medicaid_match_flag_overall == 1, 1, 0),
    #               pre_or_study_bh_flag = ifelse(study_bh_flag == 1 | pre_bh_flag == 1, 1, 0),
    #               pre_or_study_homeless_on_eligibility_begin_flag = ifelse(study_homeless_on_eligibility_begin_flag == 1 |
    #                                                                        pre_homeless_on_eligibility_begin_flag == 1, 1, 0)) 
...
#   select(county, unique_person_id, pre_or_study_window_medicaid_match_flag_overall, pre_or_study_bh_flag, pre_or_study_homeless_on_eligibility_begin_flag) %>% 
#   distinct() %>% 
#   group_by(county) %>% 
#   dplyr::summarise(# Number of people on Medicaid
#                    medicaid_n  = n_distinct(unique_person_id[pre_or_study_window_medicaid_match_flag_overall==1]),
#                    
#                    # Number of people experiencing homelessness
#                    homeless_n = n_distinct(unique_person_id[pre_or_study_homeless_on_eligibility_begin_flag==1]),
#                   
#                    ########
...
#                    bh_people_n = n_distinct(unique_person_id[pre_or_study_bh_flag==1]),
#                    
#                    # Number of people on Medicaid and BH encounters, and homeless
#                    bh_people_homeless_n = n_distinct(unique_person_id[pre_or_study_bh_flag==1 & pre_or_study_homeless_on_eligibility_begin_flag==1]),
#                    
...
#                    no_bh_people_n = n_distinct(unique_person_id[pre_or_study_bh_flag==0]),
#                    
#                    # Number of people on Medicaid and without BH encounters, and homeless
#                    no_bh_people_homeless_n = n_distinct(unique_person_id[pre_or_study_bh_flag==0 & pre_or_study_homeless_on_eligibility_begin_flag==1]),
#                   
#                    # Pct of people who dont have BH and are homeless
...
dhhs_housing_hu_pct <- jail_medicaid_analytic_individual_booking_level_dedup_hu_recode %>% 
  dplyr::group_by(hu_group_exclusive) %>% 
  dplyr::summarise(medicaid_match_n = n_distinct(unique_person_id[pre_or_study_window_medicaid_match_flag_overall==1]),
                   homeless_n       = n_distinct(unique_person_id[pre_or_study_homeless_on_eligibility_begin_flag==1]),
                   homeless_pct     = homeless_n/medicaid_match_n,
                   not_homeless_n   = n_distinct(unique_person_id[pre_or_study_homeless_on_eligibility_begin_flag==0]),
