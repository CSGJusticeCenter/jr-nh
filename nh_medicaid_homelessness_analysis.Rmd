...
PRES_gg_diverge_race <- medicaid_jail_homelessness_hu_county_statewide_data %>%
  ...
  labs(x = "Race/Ethnicity\n", y = "Proportion of Individuals\n") +
   geom_text(aes(label = ifelse(pct > .02 | pct < 0, pct_label, "")),
            ...
            color = ifelse(medicaid_jail_homelessness_hu_county_statewide_data$hu_group_overall == "High Utilizer", jri_orange, jri_gray),
            fontface = "bold"
              ) +
...
ggsave(PRES_gg_diverge_race, file="img/PRES_gg_diverge_race.png", width = 8,  height = 4, dpi = 100)
knitr::include_graphics("img/PRES_gg_diverge_race.png")
```
...
PRES_gg_diverge_age <- medicaid_jail_homelessness_hu_county_statewide_data %>%
  mutate(pct = ifelse(hu_group_overall == "High Utilizer", pct, -1*pct)) %>% 
...
```
```{r, out.width="75%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_diverge_age, file="img/PRES_gg_diverge_age.png", width = 8,  height = 4, dpi = 100)
knitr::include_graphics("img/PRES_gg_diverge_age.png")
```
