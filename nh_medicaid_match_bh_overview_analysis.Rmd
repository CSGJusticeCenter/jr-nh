...
PRES_gg_medicaid_match <- ggplot(df_medicaid_match, aes(x = county, y = pct, fill = population)) +
  ...
  #geom_hline(yintercept = mean(df_medicaid_match$pct), color=jri_gray, linetype='dotted', lwd=1.5)
```
...
```{r, out.width="100%", echo=FALSE, layout = "l-body"}
ggsave(PRES_gg_medicaid_match_hu, file="img/PRES_gg_medicaid_match_hu.png", width = 10,  height = 6, dpi = 100)
knitr::include_graphics("img/PRES_gg_medicaid_match_hu.png")
```
